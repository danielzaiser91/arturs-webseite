...
- ⚪ Google-Indexierungsproblem (www-Duplicate-Content) behoben und deployt, wartet nur noch auf Googles erneutes Crawling, kein weiterer Handlungsbedarf — Details unter 3. SEO & Sichtbarkeit
...
- ⚪ Wartet auf Daniel: Sollen 3 weitere, auf dem Server komplett leere Ordner (INBOX.Ebay, INBOX.Ebay verkauft, Sandner) aus dem lokalen Backup wiederhergestellt werden? — Details unter 6. E-Mail-Postfach
- ⚪ Wartet auf Artur: IONOS-Vertrag kündigen (Domain + E-Mail sind schon zu lima-city umgezogen, IONOS läuft vermutlich unnötig weiter mit) — Details unter 6. E-Mail-Postfach
...
- ⚪ Wartet auf Daniel (08.08.2026 neu entdeckt): Beim Abgleich fielen 3 weitere Ordner auf, die auf dem Server komplett leer sind, im lokalen Backup aber Inhalte haben — INBOX.Ebay (180 Nachrichten lokal), INBOX.Ebay verkauft (81), Sandner (33). Das hat nichts mit der 1-GB-Grenze zu tun, sieht eher nach einer Lücke beim ursprünglichen Umzug IONOS → lima-city aus. Noch nicht wiederhergestellt, da unklar ist, ob das gewollt war — Entscheidung steht aus.
